...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_60_iso_arrow(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT,
    ...
    [3] = LAYOUT_60_iso_arrow(
        ...
        _______, LALT(KC_COMM), LALT(KC_DOT), KC_LPRN, KC_RPRN, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______,       _______,      KC_RBRC, A(KC_9), A(KC_0), _______, _______, _______, _______, _______, _______, _______, _______,
