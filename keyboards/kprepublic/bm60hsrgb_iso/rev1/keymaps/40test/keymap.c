...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_iso_arrow(
            ...
            KC_NO,         KC_NO,LSFT_T(KC_Z),LT(3,KC_X),  KC_C,      KC_V,LT(3,KC_B),KC_N,        KC_M,   KC_COMM,   RCTL_T(KC_DOT),LGUI(LSFT(KC_4)), KC_RSFT,KC_NO,
    ...
    [1] = LAYOUT_60_iso_arrow(
            ...
            KC_NO,   KC_NO,         KC_NO,                            LGUI_T(KC_0),              QK_BOOT,   KC_NO,   KC_HOME, KC_PGDN, KC_END
            ),
    [2] = LAYOUT_60_iso_arrow(
            ...
            KC_NO,   KC_ESC,  KC_ESC,  CH_PROG, KC_NO,   KC_NO,   MI_LEFT, MI_DOWN, MI_UP,   MI_RGHT, KC_NO,   KC_NO,  KC_NO,   KC_NO,
    ...
    [3] = LAYOUT_60_iso_arrow(
            ...
            KC_NO,   KC_NO,         KC_LSFT,      A(KC_7), A(KC_8), KC_NO,      KC_GRV, KC_LBRC,     KC_LBRC,   KC_LBRC, LSFT(KC_LBRC),   KC_NO,   KC_NO,
